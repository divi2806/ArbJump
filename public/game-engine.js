...
// Make the class available globally with error handling
try {
    window.SpaceJumpGameClass = SpaceJumpGameClass;
    console.log('✅ SpaceJumpGameClass successfully registered globally');
} catch (error) {
    console.error('❌ Failed to register SpaceJumpGameClass globally:', error);
}